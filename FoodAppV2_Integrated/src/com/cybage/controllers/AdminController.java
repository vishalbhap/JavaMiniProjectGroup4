...
@WebServlet(urlPatterns= {"/ShowAllUsers","/AdminController/DeleteUser","/DisplayAllRestaurants","/Login","/AdminController/EditRestaurant","/AdminController/DeleteRestaurant","/Logout","/AddRestaurantOwner","/UpdateRestaurant"})
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		switch (path) {
			...
			case "/AdminController/DeleteRestaurant":
				...
				response.sendRedirect("http://localhost:9090/FoodAppV2/DisplayAllRestaurants");
				break;
			...
			case "/ShowAllUsers":
				...
				requestDispatcher = request.getRequestDispatcher("/jsp/User/displayAllUser.jsp");
				requestDispatcher.forward(request, response);
				break;
				
				
			case "/AdminController/DeleteUser":
		...
		switch (path) {
			case "/Login":
				...
				if(email.equals("admin@gmail.com") && password.equals("admin@123")) {
					response.sendRedirect("http://localhost:9090/FoodAppV2/jsp/RestaurantOwner/admin.jsp");
				}

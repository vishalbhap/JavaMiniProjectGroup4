...
<br>
	<table class="table table-striped">
		...
		<c:forEach items="${requestScope.foodItemList}" var="food">
		<tr>
			...
			<td>
			<a href="http://localhost:9090/FoodAppV2/Order?foodId=${food.foodId}"><button class="btn btn-warning">Order</button></a>
			</td>
			<td>
			<a href="removeCart?foodId=${food.foodId}"><button class="btn btn-warning">Remove</button></a>
			</td>
		</tr>
		</c:forEach>
	</table>
